...
import { ComponentPropsWithRef, ReactNode, ReactElement, isValidElement } from 'react'

import { cn } from '@/lib/utils'
import { ExtendsUnion } from '@/types'
import { colors, TextColor } from '@/ui/tokens/colors'
import {
  font,
  FontSize,
  TextWrap,
  ...
  LineHeight,
  Tracking,
} from '@/ui/tokens/fonts'
import { opacity, Opacity } from '@/ui/tokens/opacity'
import { Overflow, overflow as overflowOptions } from '@/ui/tokens/overflow'
import { whiteSpace as whiteSpaceOptions, type WhiteSpace } from '@/ui/tokens/whiteSpace'
import { WordBreak, wordBreak as wordBreakOptions } from '@/ui/tokens/wordBreak'
...
const TextAtom = ({
  ...
  const className = cn(
    ...
    extraClassName,
    {
      ...
      'underline-offset-4 hover:underline': underlineHover,
  ...
  const render = asChild && isValidElement(children) ? (children as ReactElement) : undefined
...
const Text = {
  H1: ({ ref, ...props }: TextPropsWithRef) => <TextAtom ref={ref} size='h1' {...props} />,
  H1B: ({ ref, ...props }: TextPropsWithRef) => (
    <TextAtom ref={ref} size='h1' weight='bold' {...props} />
  ),
  H2: ({ ref, ...props }: TextPropsWithRef) => <TextAtom ref={ref} size='h2' {...props} />,
  H2B: ({ ref, ...props }: TextPropsWithRef) => (
    <TextAtom ref={ref} size='h2' weight='bold' {...props} />
  ),
  H3: ({ ref, ...props }: TextPropsWithRef) => <TextAtom ref={ref} size='h3' {...props} />,
  H3B: ({ ref, ...props }: TextPropsWithRef) => (
    <TextAtom ref={ref} size='h3' weight='bold' {...props} />
  ),
  H4: ({ ref, ...props }: TextPropsWithRef) => <TextAtom ref={ref} size='h4' {...props} />,
  ...
  H5: ({ ref, ...props }: TextPropsWithRef) => <TextAtom ref={ref} size='h5' {...props} />,
  ...
  H6: ({ ref, ...props }: TextPropsWithRef) => <TextAtom ref={ref} size='h6' {...props} />,
  ...
  H6C: ({ ref, ...props }: TextPropsWithRef) => (
    <TextAtom ref={ref} size='h6' weight='bold' uppercase spacing='wide' {...props} />
  ),
  ...
  H7C: ({ ref, ...props }: TextPropsWithRef) => (
    <TextAtom ref={ref} uppercase size='h7' spacing='wide' weight='bold' {...props} />
  ),
  Mono: ({
    ref,
    children,
